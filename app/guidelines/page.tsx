              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg mb-8 border border-blue-200">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <Link
                    ...
                    className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-lg shadow-md text-gray-800 hover:bg-accent hover:white bg-primary transition-all duration-200"
                  >
